...
class MDM(nn.Module):
    ...
    def __init__(self, H):
        ...
        # self.glob_rot = H.glob_rot
        # print('glob_rot', self.glob_rot)
        # self.translation = H.translation
    ...
    # def _apply(self, fn):
    #     super()._apply(fn)
    #     print('PORFA DIGANME QUE ESTO FUNCIONA')
    #     self.rot2xyz.smpl_model._apply(fn)


    # def train(self, *args, **kwargs):
    #     super().train(*args, **kwargs)
    #     print('PORFA DIGANME QUE ESTO TAMBIEN FUNCIONA')
